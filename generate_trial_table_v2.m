function [trial_target_numbers, trial_home_numbers, trial_type, prescribed_PT, trial_stimA] = generate_trial_table_v2(subject_code)
% subject_code = 'S025';
...
%% save subject data
save(['trial_parameters_', subject_code], 'trial_target_numbers', 'trial_home_numbers', 'trial_type', 'prescribed_PT', 'trial_stimA');
